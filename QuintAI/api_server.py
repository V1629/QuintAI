...
try:
    ...
    print("✅ All QuintAI modules imported successfully")
except ImportError as e:
    print(f"❌ Error importing QuintAI modules: {e}")
    print("Make sure all required dependencies are installed and API keys are set")

...
export default function GithubCardSkew({ className, children }) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'flex flex-col gap-4 rounded-3xl border border-border shadow-lg transition-transform ease-linear will-change-transform',
        className,
      )}
      style={{
